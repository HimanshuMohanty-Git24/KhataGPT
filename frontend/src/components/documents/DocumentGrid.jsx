...
const DocumentGrid = ({ 
  ...
  const displayedDocuments = documents.slice(startIndex, startIndex + documentsPerPage);
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <SortIcon fontSize="small" sx={{ color: theme.palette.text.secondary, mr: 1 }} />
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <FilterListIcon fontSize="small" sx={{ color: theme.palette.text.secondary, mr: 1 }} />
            <FormControl size="small" variant="outlined" sx={{ minWidth: 120 }}>
              <Select
                value={filterStatus}
